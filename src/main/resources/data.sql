...
INSERT INTO "user" (id, username, firstname, lastname, password, email, phone, tenant_id, active, created_date, last_modified_date)
VALUES
    ...
    (2, 'user2', 'Jane', 'Smith', '$2a$12$AoOHtKAPAsaivOOCA0Jvxuoc68brRjCzFpyKSjGueh12R7Lky/.B6', 'jane.smith@example.com', '0987654321', 2, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO "user" (id, username, firstname, lastname, password, email, phone, tenant_id, active, created_date, last_modified_date)
VALUES
    (3, 'admin', 'Admin', 'User', '$2a$12$KnFXh31KgMKVr7CX/ZHAY.sgy49hHTE3TWj8XFYE9ZrWL7DQSjYFW', 'admin@example.com', '1234567890', 1, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    ...
    (2, 'user2', 'ROLE_USER', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO authority (id, username, authority, active, created_date, last_modified_date)
VALUES
    (3, 'admin', 'ROLE_SUPERADMIN', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    ...
    (3, 'Revise Product Design', 'Revise the product design to include customer feedback', 2, 2, 'REJECTED', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
