        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/rest/users/{tenantId}/users/create").permitAll()
                                .requestMatchers("/rest/users/admin").permitAll()
                                .requestMatchers("/rest/users/**").permitAll()
                                .requestMatchers("/rest/suggestions/create").permitAll()
                                .requestMatchers("/rest/suggestions/**").permitAll()
                                .requestMatchers("/rest/reviews/create").permitAll()
                                .requestMatchers("/rest/reviews/all").permitAll()
